...
const hasChanges = computed(() => {
  ...
  return (
    formData.value.library_scan_interval_minutes !== originalSettings.value.library_scan_interval_minutes ||
...
async function saveSettings() {
  ...
  try {
    ...
    if (formData.value.library_scan_interval_minutes !== originalSettings.value.library_scan_interval_minutes) {
    ...
    if (formData.value.cleanup_grace_period_days !== originalSettings.value.cleanup_grace_period_days) {
