    ...
    <main class="container mx-auto px-6 py-8 max-w-2xl">
      ...
      <form v-else class="space-y-6" @submit.prevent="handleSubmit">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input
              ...
              type="text"
              required
              class="appearance-none relative block w-full px-3 py-2 border border-gray-700 placeholder-gray-500 text-white bg-gray-800 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              name="language"
              class="appearance-none relative block w-full px-3 py-2 border border-gray-700 text-white bg-gray-800 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
            >
        ...
        <div class="flex gap-4">
          ...
          <router-link
            to="/"
            class="flex-1 flex justify-center py-2 px-4 border border-gray-700 text-sm font-medium rounded-md text-gray-300 bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
          >
            {{ $t('common.cancel') }}
          </router-link>
        </div>
...
async function loadUserData() {
  ...
  try {
    ...
    error.value = err.data?.detail || t('settings.updateFailed')
  } finally {
    loading.value = false
  }
}
